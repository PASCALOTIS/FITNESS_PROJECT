...
<body>
  <div class="container">
    ...
    <h2>Vegetarian</h2>
    <div class="meal">
      <img src="peach_broccoli_salad.jpg" alt="Peach and Broccoli Salad">
      <div class="meal-info">
    ...
    <div class="meal">
      <img src="creamy_chicken_spinach_pasta.jpg" alt="Creamy Chicken and Spinach Pasta">
      <div class="meal-info">
    ...
    <div class="meal">
      <img src="asian_spicy_beef.jpg" alt="Asian Spicy Beef">
      <div class="meal-info">
    ...
    <div class="meal">
      <img src="noodles_with_pesto.jpg" alt="Noodles with Pesto">
      <div class="meal-info">
    ...
    <div class="meal">
      <img src="white_beans_salad.jpg" alt="White Beans Salad">
      <div class="meal-info">
